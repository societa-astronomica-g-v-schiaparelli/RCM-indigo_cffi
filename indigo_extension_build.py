...
ffibuilder.set_source("_indigo",  r"""
  ...
  sources = ['indigo_py_adapter.c', '../indigo/indigo_libs/indigo_token.c'],
  extra_objects = ['../indigo/indigo_libs/indigo_client.o', '../indigo/indigo_libs/indigo_client_xml.o', '../indigo/indigo_libs/indigo_bus.o', '../indigo/indigo_libs/indigo_io.o', '../indigo/indigo_libs/indigo_xml.o', '../indigo/indigo_libs/indigo_version.o', '../indigo/indigo_libs/indigo_base64.o']
)
